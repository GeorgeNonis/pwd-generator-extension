// EFF-inspired short word list (subset) for diceware-style passphrases.
export const WORD_LIST = [
  "abacus", "abdomen", "abide", "ability", "ablaze", "able", "abnormal", "abort",
  "abrasive", "absorb", "abyss", "academy", "accent", "accept", "access", "accident",
  "account", "accurate", "achieve", "acid", "acoustic", "acquire", "acrobat", "actor",
  "actress", "adapt", "addict", "address", "adjust", "admit", "adopt", "adult",
  "advance", "advice", "aerial", "affair", "afford", "afraid", "after", "again",
  "agency", "agenda", "agent", "agree", "ahead", "aim", "airline", "airport",
  "aisle", "alarm", "album", "alcohol", "alert", "alien", "align", "alive",
  "alley", "allow", "almost", "alone", "alpha", "already", "also", "alter",
  "always", "amateur", "amazing", "amber", "ambient", "amend", "among", "amount",
  "amused", "anchor", "ancient", "anger", "angle", "angry", "animal", "ankle",
  "announce", "annual", "answer", "antenna", "antique", "anxiety", "apart", "apology",
  "appear", "apple", "approve", "april", "arch", "arctic", "area", "arena",
  "argue", "armor", "army", "around", "arrange", "arrest", "arrive", "arrow",
  "artist", "artwork", "aspect", "asset", "assist", "assume", "asthma", "athlete",
  ...
  "believe", "below", "bench", "benefit", "best", "betray", "better", "between",
  ...
  "career", "careful", "cargo", "carpet", "carry", "cart", "case", "cash",
  ...
  "chronic", "chunk", "churn", "cigar", "circle", "citizen", "city", "civil",
  ...
  "color", "combine", "come", "comfort", "comic", "common", "company", "concert",
